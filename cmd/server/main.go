...
func main() {
	...
	mux.HandleFunc("GET /api/v1/delivery-groups", launchHandler.RequirePortalSession("timetable.manage", portalAPIHandler.DeliveryGroups))
	mux.HandleFunc("POST /api/v1/delivery-groups", launchHandler.RequirePortalSession("timetable.manage", portalAPIHandler.DeliveryGroups))
	mux.HandleFunc("DELETE /api/v1/delivery-groups/{groupId}", launchHandler.RequirePortalSession("timetable.manage", portalAPIHandler.DeliveryGroupDetail))
	mux.HandleFunc("GET /api/v1/parallel-blocks", launchHandler.RequirePortalSession("timetable.manage", portalAPIHandler.ParallelBlocks))
	mux.HandleFunc("POST /api/v1/parallel-blocks", launchHandler.RequirePortalSession("timetable.manage", portalAPIHandler.ParallelBlocks))
	mux.HandleFunc("DELETE /api/v1/parallel-blocks/{blockId}", launchHandler.RequirePortalSession("timetable.manage", portalAPIHandler.ParallelBlockDetail))
